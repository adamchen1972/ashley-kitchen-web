...
const T = {
  ...
  'cat-nav-plye':  {en:'plyē Flooring',           zh:'plyē 地板'},
  'cat-nav-stone': {en:'Nalexible Stone',          zh:'Nalexible 石材'},
  'cat-nav-fiber': {en:'Nalexible Fiberboard',     zh:'Nalexible 纖維板'},
  ...
  'sticky-cta-copy': {en:'<strong>plyē Engineered Flooring + Nalexible Stone &amp; Fiberboard</strong> — Taiwan\'s premium building materials, globally specified.', zh:'<strong>plyē 超耐磨地板 + Nalexible 柔性石材 &amp; 天然纖維門板</strong> — 台灣頂級建材，全球指定品牌。'},
  'sticky-cta-btn':  {en:'Request a Sample →', zh:'申請樣品 →'},
  ...
  'app-sticky-copy': {en:'<strong>plyē Engineered Flooring + Nalexible Stone &amp; Fiberboard</strong> — Taiwan\'s premium building materials, globally specified.', zh:'<strong>plyē 超耐磨地板 + Nalexible 柔性石材 &amp; 天然纖維門板</strong> — 台灣頂級建材，全球指定品牌。'},
  'app-sticky-btn':  {en:'REQUEST A SAMPLE →', zh:'申請樣品 →'},
  // STICKY CTA — projects.html
  'proj-sticky-copy': {en:'<strong>plyē Engineered Flooring + Nalexible Stone &amp; Fiberboard</strong> — Taiwan\'s premium building materials, globally specified.', zh:'<strong>plyē 超耐磨地板 + Nalexible 柔性石材 &amp; 天然纖維門板</strong> — 台灣頂級建材，全球指定品牌。'},
  ...
  'f-about-text':{en:'Ashley Kitchen brings together <strong>plyē</strong> engineered flooring — made in Taiwan with patent click-lock technology — and <strong>Nalexible</strong> flexible stone &amp; fiberboard, for which we are Taiwan\'s exclusive distributor. Headquartered in Neihu, Taipei.',
                  zh:'Ashley Kitchen 整合 <strong>plyē</strong> 超耐磨工程木地板（台灣製造，專利卡扣系統）與 <strong>Nalexible</strong> 柔性石材及天然纖維門板（台灣獨家總代理），總部位於台北市內湖區。'},
  ...
  'fc-sample': {en:'Request Sample',     zh:'申請樣品'},
  ...
  'nov-cta':      {en:'Get a Quote',  zh:'立即詢價'},
  ...
  'lcc1-btn':  {en:'Request Sample →',     zh:'申請樣品 →'},
  ...
  'nl-plye':    {en:'plyē Flooring',       zh:'plyē 地板'},
  'nl-stone':   {en:'Nalexible Stone',     zh:'Nalexible 石材'},
  'nl-fiber':   {en:'Nalexible Fiberboard',zh:'Nalexible 纖維門板'},
  // Global nav — mobile overlay links (product page sub-nav, kept for backwards compat)
  'nov-plye':   {en:'plyē Flooring',       zh:'plyē 地板'},
  'nov-stone':  {en:'Nalexible Stone',     zh:'Nalexible 石材'},
  'nov-fiber':  {en:'Nalexible Fiberboard',zh:'Nalexible 纖維門板'},
  ...
  'plye-lcc1-btn':   {en:'Request Sample →',    zh:'申請樣品 →'},
  ...
  'ft-l-sample':  {en:'Request Sample',        zh:'申請樣品'},
  ...
  'idx-fc-l1': {en:'plyē ORIGIN Series',      zh:'plyē ORIGIN 系列'},
  'idx-fc-l2': {en:'plyē 12 Color Range',     zh:'plyē 12款色彩'},
  'idx-fc-l3': {en:'Nalexible Flexible Stone', zh:'Nalexible 柔性石材'},
  'idx-fc-l4': {en:'Nalexible LumiSlate',     zh:'Nalexible LumiSlate'},
  'idx-fc-l5': {en:'Nalexible Fiberboard',    zh:'Nalexible 纖維門板'},
  ...
  'fb-door-desc':    {en:'Interior doors built on Nalexible Fiber Board substrate — available in Acoustic, Magnetic, and standard variants. The continuous hemp fibre topology absorbs sound across all frequency ranges.', zh:'以 Nalexible 纖維板為基材的室內門板——提供隔音、磁力及標準款式。連續大麻纖維拓撲結構可吸收全頻段聲波。'},
  ...
  'fb-door-c1-desc': {en:'Thermoformed surface panels over a Nalexible Fiber Board core. Acoustic, magnetic and standard door variants available.', zh:'Nalexible 纖維板芯材搭配熱壓成型表面板。提供隔音、磁力及標準門款。'},
  ...
  'fb-spec-desc':  {en:'Key performance data for Nalexible Natural Fiber Board versus traditional materials.', zh:'Nalexible 天然纖維板與傳統材料的主要性能數據比較。'},
  'fb-sp-col1':    {en:'Property',                   zh:'性能'},
  'fb-sp-col2':    {en:'Nalexible Fiber Board',      zh:'Nalexible 纖維板'},
  ...
  'fb-spec-note':  {en:'Data sourced from Nalexible manufacturer specifications. Contact Ashley Kitchen for certified test reports.', zh:'數據來源：Nalexible 製造商規格書。如需認證測試報告，請聯絡 Ashley Kitchen。'},
  ...
  'stone-lcc1-btn':   {en:'Request Sample →', zh:'申請樣品 →'},
  ...
  'fb-lcc1-btn':   {en:'Request Sample →', zh:'申請樣品 →'},
