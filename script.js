...
const T = {
  ...
  'home.ab.hero.title': {en:'Three systems.<br>One clear path<br>to your next<br><em>material</em><br><em>decision.</em>', zh:'三大系統。<br>一條清晰路徑。<br>帶你走向下一個<br><em>材料</em><br><em>決策。</em>'},
  'home.ab.hero.sub': {en:'Start with the right family, compare pattern options, and move quickly into sample-ready choices.', zh:'先選對家族，再比較花色，最後快速進入可申請樣品的決策階段。'},
