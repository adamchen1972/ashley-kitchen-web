...
const T = {
  ...
  'cat-route-desc':    {en:'Choose the right stone family here first, then open the deep library to compare pattern codes and send a focused sample request.', zh:'先在這裡選對石材家族，再進入深度資料庫比對花色代碼，最後送出更聚焦的樣品需求。'},
  ...
  'cat-stone-desc':      {en:'You are now in the deep stone layer: compare families, shortlist exact pattern codes, then move directly into sample and technical follow-up.', zh:'你現在位於深度石材層：先比較家族、篩選精確花色代碼，再直接進入樣品與技術跟進。'},
  ...
  'cat-stone-footer-note':            {en:'Compare families first, confirm pattern codes second, and let Ashley Kitchen support sample review plus technical alignment for your project.', zh:'先比對家族、再確認花色代碼，接著由 Ashley Kitchen 協助樣品審核與技術對齊。'},
  'ctc-hero-sub':                     {en:'Request samples, technical specs, or project support in one place. Share your scope and we will respond as soon as possible.', zh:'在同一頁完成樣品、技術規格與專案支援需求。提供你的專案範圍，我們會盡快回覆。'},
