...
const T = {
  ...
  'sticky-cta-copy': {en:'<strong>Flooring + Stone &amp; Fiberboard</strong> — Ashley Kitchen material systems for global projects.', zh:'<strong>地板 + 石材 + 纖維板</strong> — Ashley Kitchen 的全球專案建材系統。'},
  ...
  'cat-route-desc':    {en:'Use this page to pick the right family first. Then move to the deep stone library to compare SKU codes, shortlist patterns, and request samples with Ashley Kitchen.', zh:'先在此頁選對石材家族，再進入深度石材庫比較 SKU 代碼、建立花色 shortlist，並向 Ashley Kitchen 申請樣品。'},
  ...
  'cat-route-main-btn':{en:'Open Deep Stone Library →', zh:'開啟深度石材庫 →'},
  'cat-route-sub-btn': {en:'Request Stone Samples', zh:'申請石材樣品'},
  ...
  'cat-stone-desc':      {en:'You are now in the deep stone layer: compare families, review SKU pattern grids, then send shortlisted codes for sample and technical follow-up.', zh:'你現在位於深度石材層：先比較家族，再檢視 SKU 花色庫，最後提交 shortlist 代碼進行樣品與技術跟進。'},
  ...
  'home.a.hero.title': {en:'Innovative materials for<br><em>beautifully considered</em> spaces.', zh:'為空間帶來創新材料，<br><em>成就更講究的美感體驗</em>。'},
  'home.a.hero.sub': {en:'Design-led surfaces for homes, hospitality, and commercial interiors where atmosphere matters.', zh:'以設計為先的表面材料，適用於住宅、飯店與商業室內空間，讓氛圍成為核心價值。'},
  'home.ab.hero.title': {en:'Three material families.<br>One clear path from first look to sample.', zh:'三大材料家族。<br>一條從第一眼到樣品決策的清晰路徑。'},
  'home.ab.hero.sub': {en:'Built for architects and project teams moving from first look to specification without getting lost in SKUs.', zh:'為建築師與專案團隊打造：從第一眼一路走到規格決策，不會迷失在 SKU 細節中。'},
  'home.ab.hero.step1': {en:'Choose family', zh:'選擇家族'},
  'home.ab.hero.step2': {en:'Compare patterns', zh:'比較花色'},
  'home.ab.hero.step3': {en:'Request samples', zh:'申請樣品'},
